...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(184);
	
	var _reactAddons2 = _interopRequireDefault(_reactAddons);
	
	var _srcPanel = __webpack_require__(202);
	
	var _srcPanel2 = _interopRequireDefault(_srcPanel);
	
	var _srcPanelHeader = __webpack_require__(203);
	
	var _srcPanelHeader2 = _interopRequireDefault(_srcPanelHeader);
	
	var _srcPanelTitle = __webpack_require__(183);
	
	var _srcPanelTitle2 = _interopRequireDefault(_srcPanelTitle);
	
	var _srcPanelBody = __webpack_require__(204);
	
	var _srcPanelBody2 = _interopRequireDefault(_srcPanelBody);
	
	var _srcPanelGroup = __webpack_require__(205);
	
	var _srcPanelGroup2 = _interopRequireDefault(_srcPanelGroup);
	
	var TestingContainer = (function (_React$Component) {
	    _inherits(TestingContainer, _React$Component);
	
	    function TestingContainer() {
	        _classCallCheck(this, TestingContainer);
	
	        _get(Object.getPrototypeOf(TestingContainer.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A container to test other components';
	    }
	
	    _createClass(TestingContainer, [{
	        key: 'render',
	...
	var SimplePanel = (function (_React$Component2) {
	    _inherits(SimplePanel, _React$Component2);
	
	    function SimplePanel() {
	        _classCallCheck(this, SimplePanel);
	
	        _get(Object.getPrototypeOf(SimplePanel.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'Simple panel';
	    }
	
	    _createClass(SimplePanel, [{
	        key: 'render',
	        value: function render() {
	            return _reactAddons2['default'].createElement(
	                TestingContainer,
	                ...
	                _reactAddons2['default'].createElement(
	                    ...
	                    null,
	                    _reactAddons2['default'].createElement(
	                        _srcPanelHeader2['default'],
	                        null,
	                        _reactAddons2['default'].createElement(
	                            _srcPanelTitle2['default'],
	                            null,
	                            'The Opera'
	                        )
	                    ),
	                    _reactAddons2['default'].createElement(
	                        _srcPanelBody2['default'],
	                        null,
	...
	var MultiPanel = (function (_React$Component3) {
	    _inherits(MultiPanel, _React$Component3);
	
	    function MultiPanel() {
	        _classCallCheck(this, MultiPanel);
	
	        _get(Object.getPrototypeOf(MultiPanel.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'Simple panel';
	    }
	
	    _createClass(MultiPanel, [{
	        key: 'render',
	        value: function render() {
	            return _reactAddons2['default'].createElement(
	                TestingContainer,
	...
	var CollapsiblePanel = (function (_React$Component4) {
	    _inherits(CollapsiblePanel, _React$Component4);
	
	    function CollapsiblePanel() {
	        _classCallCheck(this, CollapsiblePanel);
	
	        _get(Object.getPrototypeOf(CollapsiblePanel.prototype), 'constructor', this).apply(this, arguments);
	...
	_reactAddons2['default'].render(_reactAddons2['default'].createElement(SimplePanel, null), document.getElementById('simple-panel'));
	_reactAddons2['default'].render(_reactAddons2['default'].createElement(MultiPanel, null), document.getElementById('multi-panel'));
	_reactAddons2['default'].render(_reactAddons2['default'].createElement(CollapsiblePanel, null), document.getElementById('collapsible-panel'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelTitle = (function (_React$Component) {
	    ...
	    function PanelTitle() {
	        _classCallCheck(this, _PanelTitle);
	
	        _get(Object.getPrototypeOf(_PanelTitle.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A component for the panel title';
	    ...
	    _createClass(PanelTitle, [{
	        ...
	        value: function render() {
	            ...
	            if (collapse) {
	                elem = _react2['default'].createElement(
	                    'a',
	                    { href: "#", style: this.getStyles().href, onClick: clickFunc },
	                    children
	                );
	            } else {
	                elem = children;
	        ...
	        value: {
	            ...
	            clickFunc: _react2['default'].PropTypes.func,
	            collapse: function collapse(props, propName) {
	                if (props[propName]) {
	    ...
	    var _PanelTitle = PanelTitle;
	    PanelTitle = (0, _radium2['default'])(PanelTitle) || PanelTitle;
	    return PanelTitle;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(190);
	var ReactFragment = __webpack_require__(10);
	var ReactTransitionGroup = __webpack_require__(191);
	var ReactUpdates = __webpack_require__(24);
	
	var cx = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Panel = (function (_React$Component) {
	    ...
	    function Panel() {
	        ...
	        _get(Object.getPrototypeOf(_Panel.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A top level component for containing other panel components';
	        this.state = {
	            click: false,
	            open: true
	        };
	
	        this.onChildClick = function () {
	            _this.setState({
	                click: true,
	        ...
	        this.renderChildren = function () {
	            ...
	            if (collapse) {
	                var newChildren = _reactAddons2['default'].Children.map(children, function (child) {
	                    return _reactAddons2['default'].cloneElement(child, {
	                        open: _this.state.open,
	                        collapse: collapse,
	                        clickFunc: _this.onChildClick,
	                        clicked: _this.state.click
	                    });
	                });
	                return newChildren;
	            }
	    ...
	    _createClass(Panel, [{
	        ...
	        value: {
	            ...
	            collapse: _reactAddons2['default'].PropTypes.bool
	        },
	        enumerable: true
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelHeader = (function (_React$Component) {
	    ...
	    function PanelHeader() {
	        ...
	        _get(Object.getPrototypeOf(_PanelHeader.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A component for panel header';
	    ...
	    PanelHeader = (0, _radium2['default'])(PanelHeader) || PanelHeader;
	    return PanelHeader;
	})(_react2['default'].Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelBody = (function (_React$Component) {
	    ...
	    function PanelBody() {
	        ...
	        _classCallCheck(this, _PanelBody);
	
	        _get(Object.getPrototypeOf(_PanelBody.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A component for the panel content';
	    ...
	    var _PanelBody = PanelBody;
	    PanelBody = (0, _radium2['default'])(PanelBody) || PanelBody;
	    return PanelBody;
	})(_react2['default'].Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PanelGroup = (function (_React$Component) {
	    ...
	    function PanelGroup() {
	        _classCallCheck(this, _PanelGroup);
	
	        _get(Object.getPrototypeOf(_PanelGroup.prototype), 'constructor', this).apply(this, arguments);
	
	        this.displayName = 'A top level component for group multiple panel';
	    ...
	    var _PanelGroup = PanelGroup;
	    PanelGroup = (0, _radium2['default'])(PanelGroup) || PanelGroup;
	    return PanelGroup;
	})(_reactAddons2['default'].Component);
